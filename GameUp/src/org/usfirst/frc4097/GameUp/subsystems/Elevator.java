...
public class Elevator extends Subsystem {
    ...
    private final SpeedController linearMotor = RobotMap.elevatorlinearMotor;
    private final DigitalInput scaleSwitch = RobotMap.elevatorscaleSwitch;
    private final DigitalInput switchSwitch = RobotMap.elevatorswitchSwitch;
    ...
    public void joystickInput(Joystick main){
    	Counter scale = new Counter(scaleSwitch);
    	Counter witch = new Counter(switchSwitch);
