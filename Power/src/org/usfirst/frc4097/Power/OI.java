...
import org.usfirst.frc4097.Power.subsystems.*;
...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("BoxIn", new BoxIn());
        SmartDashboard.putData("BoxOut", new BoxOut());
        SmartDashboard.putData("DriveForward", new DriveForward());
        SmartDashboard.putData("toSwitch", new toSwitch());
